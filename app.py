#Utilities
'''
# Set and start virtual environment
python3 -m venv .venv
source .venv/bin/activate

# Install all of the modules.
pip3 install google-generativeai python-dotenv flask flask-restful flask-httpauth
'''
...
if (__name__) == "__main__":
    app.run(debug=True, port=5700, ssl_context=("/Users/david/.ssl/cert.pem","/Users/david/.ssl/key.pem"))
